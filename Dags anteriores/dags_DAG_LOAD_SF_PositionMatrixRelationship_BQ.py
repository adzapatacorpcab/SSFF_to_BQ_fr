...
endpoint = "PositionMatrixRelationship" #Tabla
project_id = "psa-sga-dfn-pr" #Proyecto
actualizacion ="30 10 * * *" #minuto dia mes dia de la semana si se quiere una vez es @once
...
with models.DAG(
    ...
    def get_api_data(base_url, endpoint, page_size, username, password, filter_conditions, num_pages=2):
        all_data = []
