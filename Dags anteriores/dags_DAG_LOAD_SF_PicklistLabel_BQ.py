...
endpoint = "PicklistLabel" #Tabla
project_id = "psa-sga-dfn-pr" #Proyecto
actualizacion ="0 13 * * *" #minuto dia mes dia de la semana si se quiere una vez es @once
##Formato de la actualizacion ### MINUTO - HORA - DIA - MES - DIA DE LA SEMANA 
########################################################################################
ENV_ID = os.environ.get("SYSTEM_TESTS_ENV_ID")
PROJECT_ID = os.environ.get("SYSTEM_TESTS_GCP_PROJECT")
DAG_ID = "DAG_LOAD_SF_"+endpoint+"2_BQ"


base_url = "https://api19.sapsf.com/odata/v2/"
page_size = 1000  # Tamaño de página
username = Variable.get("ssff_user")
password = Variable.get("ssff_pass")
...
with models.DAG(
    ...
    def correo():
        ...
        smtp_port = 587
        smtp_username = Variable.get("sp_user")
        smtp_password = Variable.get("sp_pass")
        
        # Lista de destinatarios
        destinatarios = ["aejuarez@corpcab.com.mx","rcasillas@corpcab.com.mx"]
